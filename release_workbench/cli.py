...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    verify_parser = subparsers.add_parser(
        ...
        description="Scan regular files under Contents of a .app bundle, parse the embedded "
        "code signature of each Mach-O file, and print a JSON issue report.",
    )
    ...
    verify_parser.add_argument(
        ...
        metavar="TEAM_ID",
        default=None,
        help="expected developer team identifier",
    )
