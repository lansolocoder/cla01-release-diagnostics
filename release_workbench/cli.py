...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    deps_parser = subparsers.add_parser(
        "check-deps",
        help="check architectures and dylib dependencies of Mach-O files in a .app bundle",
        description="Scan regular files below Contents of a .app bundle, parse every "
        "recognized 64-bit Mach-O (including fat slices), and print a JSON report of "
        "CPU architectures and linked dylib dependencies.",
    )
    ...
    deps_parser.add_argument(
        ...
        metavar="ARCH",
        default=None,
        help="required architecture (arm64 or x86_64); Mach-O files lacking it are reported",
    )
